...
![ActorSystem模型例子](/images/actor-system-example.png)
...
class ManagerActor extends Actor {
  ...
  def receive: Receive = {
    case m: Meeting =>
      //主管收到Boss的通知，回应我已经收到命令会马上参加会议
      sender() ! Confirm("I have receive command", self.path)
    case d: DoAction =>
      //主管寻找合适的Worker，并将老板布置的任务分配给他去完成
...
![程序流程图](/images/company-system-example.png)
